...
rp= 'IHC'
x = 'IHC '
if 'IHC'==user and 'MAHIM'==pas:
	Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL JOIN MY FACEBOOK GROUP ")
	os.system('xdg-open https://facebook.com/groups/931424681514218/')
else:
	Axak(y+"\n\n\t\t      Invalid User Or Pass")
	Axak(y+"\n\n\t\tContract Admin For User And Pass")
	os.system("xdg-open https://www.facebook.com/profile.php?id=100067749970986")
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥IHC🔥 "+w+tim)
